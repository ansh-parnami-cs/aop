...
/**
 * Aspect class responsible for synchronizing relational database
 * UserEntity data into MongoDB after a successful save operation.

 * This uses Spring AOP to intercept the save() method execution
 * of UserRepository and replicate the data into MongoDB.
 * @author Ansh Parnami
 * @since 2026-02-26
 */
...
public class MongoSyncAspect {
    ...
    @Autowired
    DataSyncAdapter<UserDoc, UserEntity> dataSyncAdapter;

    /**
     * Advice that runs AFTER the successful execution of:
     *      UserRepository.save(..)
